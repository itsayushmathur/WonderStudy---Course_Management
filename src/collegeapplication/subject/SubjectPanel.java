...
public class SubjectPanel extends JPanel implements ActionListener {
	...
	public SubjectPanel(StudentMain sm) {
		...
		scrollPane.setBounds(10, headerlabel.getY() + headerlabel.getHeight() + 20, 1096,
				this.getHeight() - headerlabel.getHeight() - 20);
...
//		timer.start();
		...
		addsubject.setBackground(new Color(255, 0, 0));
