...
public class ViewFacultyPanel extends JPanel {
	...
	private ViewFacultyPanel(Faculty f) {
		...
		assignsubjectbutton.setForeground(Color.RED);
		...
		if (f.getCourseCode() == null || f.getCourseCode().equals("Not Assigned")) {
			...
			semoryearlabel.setText("  " + new CourseData().getsemoryear(f.getCourseCode()) + "-" + f.getSemorYear()
					+ " " + " (" + f.getCourseCode() + ")");
		}
	...
	public ViewFacultyPanel(Faculty f, AdminMain am, JComponent lastpanel) {
		...
		editdetailsbutton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				AddFacultyDialog ad = new AddFacultyDialog(am, f);
