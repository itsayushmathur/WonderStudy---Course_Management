...
public class ViewStudentPanel extends JPanel {
	...
	private ViewStudentPanel(Student s) {
		...
		editdetailsbutton.setForeground(Color.RED);
		...
		marksheetbutton.setForeground(Color.RED);
		...
		JLabel semoryearlabel = new JLabel("  " + new CourseData().getsemoryear(s.getCourseCode()) + "-"
				+ s.getSemorYear() + " " + " (" + s.getCourseCode() + ")");
	...
	public ViewStudentPanel(Student s, AdminMain am, JComponent lastpanel) {
		...
		marksheetbutton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				am.marksheetpanelscroll = new JScrollPane(am.marksheetpanel, JScrollPane.VERTICAL_SCROLLBAR_ALWAYS,
		...
		backbutton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if (lastpanel.getName().equals("Student Panel")) {
					 ...
					 am.studentpanel.createtablemodel(); } else {
					...
					am.attendancereportpanel.createtablemodel();
					am.attendancereportpanelscroll.setVisible(true);
	...
	public ViewStudentPanel(Student s, FacultyMain fm, JComponent lastpanel) {
		...
		marksheetbutton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				fm.marksheetpanelscroll = new JScrollPane(fm.marksheetpanel, JScrollPane.VERTICAL_SCROLLBAR_ALWAYS,
						JScrollPane.HORIZONTAL_SCROLLBAR_NEVER);
		...
		backbutton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if (lastpanel.getName().equals("Student Panel")) {
					  ...
					  fm.studentpanel.createtablemodel(); } else {
					  fm.studentpanel.createphotopanel(); }
					 
					fm.studentpanel.setVisible(true);
				} else if (lastpanel.getName().equals("Attadance Report Panel Scroll")) {
					fm.attendancereportpanel.createtablemodel();
					fm.attendancereportpanelscroll.setVisible(true);
				} else if (lastpanel.getName().equals("Search Panel")) {
		...
		backbutton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if (lastpanel.getName().equals("Student Panel")) {
					  ...
					  sm.studentpanel.createtablemodel(); } else {
					  sm.studentpanel.createphotopanel(); }
					 
					sm.studentpanel.setVisible(true);
				} else if (lastpanel.getName().equals("Attadance Report Panel Scroll")) {
					sm.attendancereportpanel.createtablemodel();
