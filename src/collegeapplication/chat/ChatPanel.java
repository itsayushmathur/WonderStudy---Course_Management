...
public class ChatPanel extends JPanel {
	...
	public ChatPanel() {
		...
		contactnamelabel = new JLabel("MCA Winnning Group");
		...
		bottomlabel = new JLabel("45 Members online");
	...
	public void setToUserData(String userprofile, String touserid, String tousername, Image tousericon,
			String lastlogin, boolean isactive) {
