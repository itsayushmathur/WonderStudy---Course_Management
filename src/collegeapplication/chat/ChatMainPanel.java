...
public class ChatMainPanel extends JPanel {
	...
	public ChatMainPanel(FacultyMain fm) {
		...
		BufferedImage image = ImageUtil
				.toBufferedImage(fm.f.getProfilePic().getScaledInstance(50, 50, Image.SCALE_SMOOTH));
		profilepiclabel.setIcon(new ImageIcon(ImageUtil.makeRoundedCorner(image, 50)));
	...
	public ChatMainPanel() {
		...
		contactlistpanelscroll = new JScrollPane(JScrollPane.VERTICAL_SCROLLBAR_ALWAYS,
