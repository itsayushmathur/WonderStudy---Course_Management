...
//All the data related to admin displaying using this panel
...
public class AdminProfilePanel extends JPanel {
	...
	public AdminProfilePanel() {
		...
		JLabel websitelabel = new JLabel("<html>&nbsp <u>https://www.wonderstudy.ac.in/</u></html>");
		websitelabel.setToolTipText("www.wonderstudy.ac.in");
