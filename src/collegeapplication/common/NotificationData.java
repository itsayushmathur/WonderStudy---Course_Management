...
public class NotificationData {
	...
	public ArrayList<Notification> getNotifications(String coursecode, int semoryear, String userprofile,
			String joinedtime) {
		ArrayList<Notification> list = new ArrayList<Notification>();
		try {
			String query = "select * from notification where coursecode='" + coursecode + "'  and semoryear="
					+ semoryear + " and userprofile='" + userprofile + "' order by sr_no desc";
	...
	public int getUnreadNotification(String userid, String userprofile, String coursecode, int sem, String joinedtime) {
		int total = 0;
		try {
			String query = "select readby,time from notification where coursecode='" + coursecode + "' and semoryear="
					+ sem + " and userprofile='" + userprofile + "'";
			Statement st = con.createStatement();
