...
public class UserData {
	...
	public ArrayList<User> getUserInfo(String condition) {
		...
		try {
			String query = "select coursecode as 'Course',semoryear as 'Sem/Year',userid as 'Userid',logintime as 'Login Time',userprofile as 'User Profile' from users "
					+ condition + " order by sr_no desc";
